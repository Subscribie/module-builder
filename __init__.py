...
from subscribie import (current_app, Jamla, logger)
...
def journey_complete_subscriber(sender, **kw):
    logger.info("Journery Complete! Send an email or something..")
    try:
        email = kw['email']
        ...
        logger.info("Error sending journey_complete_subscriber email")
        pass
